...
fn main() -> std::process::ExitCode {
    ...
    if args == ["--version"] { println!("Burrow {}", burrow::VERSION); return std::process::ExitCode::SUCCESS; }
    ...
    match eframe::run_native("Burrow", options, Box::new(move |cc| Ok(Box::new(ui::Burrow::new(cc, smoke))))) {
